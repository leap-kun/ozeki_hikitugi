...
from Filter_3D import apply_median_filter
...
class depth_estimater:
    ...
    def ImageCallback(self, pose_data, depth_data):
        ...
        try:
            ...
            deg_R1,deg_R2 = shoulder_ik(self.LPF_ez)
            ...
            Deg = np.array([self.LPF_ez[0],self.LPF_ez[1],self.LPF_ez[2]])
            ...
            point = np.array([robot_RSholuder[0],robot_RElbow[0],self.LPF_ez[0],score_RSho,score_REl])
