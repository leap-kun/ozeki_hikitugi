...
def CameratoPixel(point):
    ...
    internal_parameters = np.array([[fx, 0, cx], [0, fy, cy], [0, 0, 1]])
    camera_coordinates = np.array([point.x/point.z, point.y/point.z, 1])
    # Apply internal parameters matrix
    
    screen_point = np.dot(internal_parameters,camera_coordinates.T)
