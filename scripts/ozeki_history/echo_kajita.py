...
class depth_estimater:
    ...
    def ImageCallback(self, pose_data, rgb_data):
        ...
        try:
            ...
            deg_R2 = atan2_deg(robot_y0,robot_y1,robot_y2,robot_z0,robot_z1,robot_z2) - 90
            deg_L2 = atan2_deg(robot_yL5,robot_y1,robot_yL6,robot_zL5,robot_z1,robot_zL6) - 90
