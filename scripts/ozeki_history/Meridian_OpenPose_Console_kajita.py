            ...
            while True:
                ...
                if (checksum[0] == r_meridim[MSG_SIZE-1]) and (frame_sync_r_resv != frame_sync_r_last): 
                    ...
                    # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
                        ...
                        #rospy.Subscriber('ros_openpose_HTH_array', Int16MultiArray ,callback)
...
def openpose_cb(Pub_deg):
    ...
    r_openpose = Pub_deg.data[0]
    
    '''                        
    R2_Motor = round(Pub_deg.data[0] * 100)
    #L2_Motor = Pub_deg.data[1]
    print("R2_Motor:",R2_Motor/100)
    #print("L2_Motor:",L2_Motor)
    s_meridim_motion[55] =  R2_Motor
    #s_meridim_motion[25] =  L2_Motor
