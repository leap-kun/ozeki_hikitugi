            ...
            while True:
                ...
                if (checksum[0] == r_meridim[MSG_SIZE-1]) and (frame_sync_r_resv != frame_sync_r_last): 
                    ...
                    # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
                        ...
                        """
                        def callback(data):
                            value_from_KRS = data.data
                            rospy.sleep(0.1)
                            s_meridim_motion[55] = value_from_KRS
    
                            # メッセージをBagファイルに保存
                            if bag is not None:
                                bag.write("ros_openpose_HTH", data)
                                
                        #bagfile生成
                        bag = rosbag.Bag("/home/kajilab/catkin_ws/src/ros_openpose/rosbag_file/example.bag", "w")
                        
                        rospy.Subscriber('ros_openpose_HTH',Int16,callback)
                        ...
                        print("s_meridim:",s_meridim_motion[55])
