...
def meridian_loop():
    ...
    global l4_openpose
    global l4_openpose_LPF
    
    global r4_openpose
    global r4_openpose_LPF
        ...
        with closing(sock):
            while True:
                ...
                if (checksum[0] == r_meridim[MSG_SIZE-1]) and (frame_sync_r_resv != frame_sync_r_last): 
                    ...
                    #右肩ロール
                    r2_opsepose_LPF += 0.1*(-r2_opsepose_LPF + r2_openpose)
                    s_meridim_motion[55] =  round(100 * r2_opsepose_LPF)
                    """
                    ...
                    if flag_OpenPose_action:
                        ...
                        #左肘ピッチ
                        l4_openpose_LPF += 0.1*(-l4_openpose_LPF + l4_openpose)
                        s_meridim_motion[29] =  round(100 * l4_openpose_LPF)
                        ...
                        #右肘ピッチ
                        r4_openpose_LPF += 0.1*(-r4_openpose_LPF + r4_openpose)
                        s_meridim_motion[59] =  round(100 * r4_openpose_LPF)
...
def openpose_cb(Pub_Conv_deg):
    ...
    l2_openpose = Pub_Conv_deg.data[0]
    l4_openpose = Pub_Conv_deg.data[1]
    r2_openpose = Pub_Conv_deg.data[2]
    r4_openpose = Pub_Conv_deg.data[3]
