...
def ChDegtoKRS(trim_arg,deg_arg,cw_arg):

    krs = 7500 + trim_arg + deg_arg * 100 / 3.375 * cw_arg
...
class depth_estimater:
    ...
    def ImageCallback(self, pose_data, rgb_data):
        ...
        try:
            ...
            HTH_R_2 = int(ChDegtoKRS(trim_r[2],conv_deg_R2,cw_r[2]))
            HTH_L_2 = int(ChDegtoKRS(trim_l[2],conv_deg_L2,cw_l[2]))
